...
class RectangleMapTool(QgsMapToolEmitPoint):
    ...
    def showRect(self, startPoint, endPoint):
        ...
        self.rubberBand.addPoint(point4, False)    # true to update canvas
...
#             # self.msg.setText(str(self.points))
#             # self.msg.show()
#             map_polygon = QgsGeometry.fromPolygonXY([self.points])
#             # self.msg = QMessageBox()
#             # self.msg.setText(str(map_polygon))
#             # self.msg.show()
...
#             # self.msg = QMessageBox()
#             # self.msg.setText(str(self.poly_bbox))
#             # self.msg.show()
